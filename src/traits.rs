...
///
/// ```rust
/// use axlib_fixed::{traits::Fixed, types::U12F4};
///
/// fn checked_add_times_500<F: Fixed>(lhs: F, rhs: F) -> Option<F>
/// where
///     u16: Into<F::Bits>,
...
///
/// ```compile_fail
/// use axlib_fixed::{traits::Fixed, types::I12F4};
///
/// fn checked_add_times_500<F: Fixed>(lhs: F, rhs: F) -> Option<F>
/// where
///     u16: Into<F::Bits>,
...
///
/// ```rust
/// use axlib_fixed::traits::LossyFrom;
/// use axlib_fixed::types::{I12F4, I4F60};
/// // original is 0x1.234
...
///
/// ```rust
/// use axlib_fixed::traits::LossyInto;
/// use axlib_fixed::types::{I12F4, I4F12};
/// // original is 0x1.234
...
///
/// ```rust
/// use axlib_fixed::traits::FromFixed;
/// use axlib_fixed::types::U8F8;
/// // 0x87.65
...
///
/// ```rust
/// use axlib_fixed::traits::ToFixed;
/// use axlib_fixed::types::{U8F8, U16F16};
